...
with np.load('best_deeper_model.npz') as f:
...
print(test_p[:10])
np.savez('/home/rqiao/predict/deepmodel_Resize.npz',test_p)
...
print(test_p[:10])
np.savez('/home/rqiao/predict/deepmodel_Rotate90.npz',test_p)
...
print(test_p[:10])
np.savez('/home/rqiao/predict/deepmodel_Rotate180.npz',test_p)
...
print(test_p[:10])
np.savez('/home/rqiao/predict/deepmodel_Rotate270.npz',test_p)
...
print(test_p[:10])
np.savez('/home/rqiao/predict/deepmodel_FlipX.npz',test_p)
